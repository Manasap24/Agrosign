...
//   const process =
//     data.translations[0]?.process_name || "Unknown";
...
//   // processList -> process names
//   // videoList -> actual video URLs
//   const playlist = videoList.map((video, index) => ({
//     process: processList[index] || `Video ${index + 1}`,
//     video: video,
//   }));
